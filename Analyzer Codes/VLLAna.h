...
// Fri Sep  2 17:09:48 2022 by ROOT version 6.26/04
// from TTree Events/Events
// found on file: 19FB6B84-57CB-0A44-ABEC-3DE8EC628746.root
//////////////////////////////////////////////////////////
...
public :
   ...
   TTreeReader     fReader_MC;  //!the tree reader
   TTreeReader     fReader_data;  //!the tree reader
  ...
  /*TTreeReaderValue<Bool_t> L1Reco_step = {fReader, "L1Reco_step"};
   ...
   TTreeReaderValue<Bool_t> HLT_TriplsportseMu_5_3_3_Mass3p8_DZ = {fReader, "HLT_TripleMu_5_3_3_Mass3p8_DZ"};
...
private:
  ...
  int        nEvtTotal, nEvtRan, n_2L, n_1L1Tau, n_1L2J;
  ...
  vector<Lepton>  GenTaus, GoodTaus, GoodJets ,bTagJets,
    bTagJets_TTbarCR, bTagJets_MedWP, cTagJets, cTagJets_Mis,LightTagJets, LightTagJets_Mis,tempGoodEle, GenEle, GoodEle, tempGoodMu, GenMu, GoodMu, llep, loosellep, looseMu, looseEle, Genllep;
  ofstream outfile;
  float  bTagEff2018(int MCsample, vector<Lepton>Jet);
  ...
  double getScaleFactors_Muons_Reco_UL18(float pt , float eta);
