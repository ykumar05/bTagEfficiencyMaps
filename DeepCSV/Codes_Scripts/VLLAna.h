...
private:
  ...
  vector<Lepton>  GenTaus, GoodTaus, GoodJets ,bTagJets, bTagJets_MedWP, cTagJets, cTagJets_Mis,LightTagJets, LightTagJets_Mis,tempGoodEle, GenEle, GoodEle, tempGoodMu, GenMu, GoodMu, llep, loosellep, looseMu, looseEle, Genllep;
  ofstream outfile;
